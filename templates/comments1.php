...
<?php if ( comments_open() ) : ?>
	...
	?>
	<div class="clear"></div>
	<div class="h2"><?php _e("Comments",twc_lang);?></div>
	<div id="ccom">
...
<div class="comments">
<div class="comcont"><div><p><?php _e("No comments yet!",twc_lang);?></p></div></div>
<div class="clear"></div>
</div>
...
<div>
	<div class="h2"><?php _e("Add new comment",twc_lang);?></div>
...
<?php else : ?>
	...
	<input class="text" type="text" id="name" name="author" placeholder="<?php _e("Your name",twc_lang);?>" value="<?php echo $comment_author; ?>" />
