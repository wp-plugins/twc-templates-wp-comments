...
function twc_stylesheet(){
	...
	if( is_singular() && comments_open()){
		wp_enqueue_style("twc_style1_templ",plugins_url('templates/css/style1.css',__FILE__));
		wp_enqueue_script("twc_script_templ",plugins_url('templates/js/script.js',__FILE__),array('jquery'));
...
function twc_stylesheet_adm(){
	wp_enqueue_style("twc_style-adm",plugins_url('css/style-adm.css',__FILE__));
}
